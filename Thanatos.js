...
const site_name = "sfc9982's blog on Edge";
const site_desc = "基于边缘计算的动态博客系统";
...
const copyright = `&copy; 2021 ${site_name} | <a href="https://github.com/sfc9982/BlogDyna-on-Edge" target="_blank">Github</a>`;
  ...
  if ($_GET['p'] == undefined) {
    ...
    data += `
          ...
          <script type="text/javascript">
            var textcontent = \`
`;
    var url = "https://raw.githubusercontent.com/" + github_base + "/main/" + $_GET['p'];
    const init = {
      method: "GET"
    };
    const response = await fetch(url, init);
